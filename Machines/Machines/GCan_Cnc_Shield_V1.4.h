...
#define X_DIRECTION_PIN         GPIO_NUM_25 // ok
#define Y_STEP_PIN              GPIO_NUM_26 // ok
#define Y_DIRECTION_PIN         GPIO_NUM_27 // ok
#define Z_STEP_PIN              GPIO_NUM_12 // ok
#define Z_DIRECTION_PIN         GPIO_NUM_14 // ok

#define X_LIMIT_PIN             GPIO_NUM_17 // ok
#define Y_LIMIT_PIN             GPIO_NUM_16  // ok
#define Z_LIMIT_PIN             GPIO_NUM_4 // ok
...
#define PROBE_PIN               GPIO_NUM_15  // labeled Probe  // ok
